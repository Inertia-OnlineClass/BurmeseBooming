...
echo "                                    $WHITE Modified by$RED inertia"
echo ""
...
printf "\e[1;92m[\e[0m 2\e[1;92m ]\e[0m>>>\e[1;33m Boom Record \e[0m\n"
...
if [ "$options" -eq "1" ];then
        echo ""
        printf "             \e[1;92m[\e[0m xlr8\e[1;92m ]\e[0m \e[1;93mEnter target  >>> \e[0m+95"
        read targett
        if [[ $targett = $SECRET ]]
        then
